...
// Game State Object
let gameState = {
    playerName: "รุ่นพี่", // Default player name
...
function openNameInputModal() {
    ...
    if (overlay && input) {
        input.value = gameState.playerName || "รุ่นพี่";
...
function confirmPlayerNameAndStart() {
    ...
    gameState.playerName = name || "รุ่นพี่";
    closeNameInputModal();
    startNewGame();
}
...
function saveGame() {
    const saveData = {
        playerName: gameState.playerName || "รุ่นพี่",
...
function loadGame() {
    ...
    try {
        ...
        // Restore state
        gameState.playerName = saveData.playerName || "รุ่นพี่";
...
- You easily get flustered by complicated coding errors and look up to your Senior/Mentor (the player, named "${gameState.playerName || 'รุ่นพี่'}") to guide you.
...
- Speech Style:
  ...
  * Refers to the player as "${gameState.playerName || 'รุ่นพี่'}" or "พี่${gameState.playerName || ''}" or "พี่" and herself as "หนู" or "โซระจัง".
...
You are chatting with your Senior Mentor AI Engineer (the player, named "${gameState.playerName || 'รุ่นพี่'}").
